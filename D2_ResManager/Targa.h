...
public:
	...
	static Targa *LoadTargaImage(const void *data, DWORD type);
	static Targa *LoadTargaImage(int width, int height, void *data);
	void Destroy();
	void *GetData(void *data);
	int SaveTargaImage(const TCHAR *filename);
};
